<template>
  <div class="skill skill-3">
    <div class="svg-container">
      <svg  x="0px" y="0px" width="48px" height="48px" viewBox="0 0 48 48" >
        <g transform="translate(-220.62 -300.98)">
          <g transform="matrix(.20627 0 0 .20627 539.45 317.71)">
            <g transform="matrix(.70214 -.71204 .71204 .70214 -1050.9 -48.428)">
            ...
            <g transform="matrix(.69167 -.67537 .68923 .67776 -1730.1 183.53)">
              <g transform="matrix(1.0952 0 0 .94705 -54.329 39.291)">

                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="147933.2031" y1="170067.9844" x2="148725.6719" y2="170067.9844" gradientTransform="matrix(0.0076 6.290013e-004 5.490298e-004 0.0064 919.6418 -4985.4004)">
              ...
              <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="-57104.418" y1="-52232.8633" x2="-57102.9805" y2="-52216.8242" gradientTransform="matrix(0.0068 7.329602e-005 7.099845e-005 0.0061 960.9309 -4675.5815)">
                <stop  offset="0" style="stop-color:#1A1A1A"/>
                <stop  offset="0.3424" style="stop-color:#CD88DF"/>
                <stop  offset="0.6888" style="stop-color:#CA23F6"/>
              ...
              <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="93176.9063" y1="-232059.3438" x2="93192.5313" y2="-231884.9063" gradientTransform="matrix(0.0068 -7.329579e-005 7.099845e-005 -0.0061 960.9299 -4381.4702)">
                <stop  offset="0" style="stop-color:#1A1A1A"/>
                <stop  offset="0.3424" style="stop-color:#CD88DF"/>
                <stop  offset="0.6888" style="stop-color:#CA23F6"/>
                <stop  offset="1" style="stop-color:#D32DFF"/>
    ...
    <div class="skill-content">
      <p>
        <strong>Familiarity with a wide range of client side development tools.</strong>
